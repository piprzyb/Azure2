...
# Total:        114  160  28.0    172     199#
 ...
 ab -n 10 -v 4 -p data.json -T 'application/json' -H 'Authorization: Bearer REPLACE_WITH_KEY' http://7d249654-31f3-4bb0-a5f8-46d465e17dce.southcentralus.azurecontainer.io/score
